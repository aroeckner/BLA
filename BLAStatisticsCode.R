...
model <- aov(ED_ChanceofDying ~ ED_Event_BroadClass, data = AURORA_BLA)
...
#Pre-pcl, 6monthpcl and 2wk RBLA, 6monthpcl and 6m LBLA
#Left
...
#CTQ, 6monthpcl and R 2wk BLA, 6monthpcl and 6m LBLA
#Left
...
#Change in BLA reactivity and change in PTSD symptoms
#Left
...
#Pre-pcl5
#Left change BLA
M6pcl_ChangeLBLA_prepcl <- glm(M6_PCL5_RS ~ Mclean + Temple + WSU + PRE_PCL5_RS + ED_Age + ED_RaceEthCode + ED_Event_BroadClass + ED_GenderBirthCert + LBLA_dif, family="poisson", data=AURORA_BLA)
...
#Supplementary analyses for Discovery Cohort:
#Linear and non-linear effects of baseline left BLA reactivity
...
#Linear and non-linear effects of baseline right BLA reactivity
...
#Fearful and neutral Poisson regression models
#Variables: LBLA_wk2_fear	RBLA_wk2_fear	LBLA_M6_fear	RBLA_M6_fear	LBLA_fear_change	RBLA_fear_change	LBLA_wk2_neutral	RBLA_wk2_neutral	LBLA_M6_neutral	RBLA_M6_neutral	LBLA_neutral_change	RBLA_neutral_change

#2-week right BLA, Month 6PCL, fear, neutral 
#Month6 pcl, Change LBLA, fear,neutral
#fear
M6pcl_Wk2RBLAfear <- glm(M6_PCL5_RS ~ Mclean + Temple + WSU +  ED_Age + ED_RaceEthCode + ED_Event_BroadClass + ED_GenderBirthCert + RBLA_wk2_fear, family="poisson", data=AURORA_BLA)
...
#neutral
M6pcl_Wk2RBLAneutral <- glm(M6_PCL5_RS ~ Mclean + Temple + WSU + ED_Age + ED_RaceEthCode + ED_Event_BroadClass + ED_GenderBirthCert + RBLA_wk2_neutral, family="poisson", data=AURORA_BLA)
...
#6-month left BLA, Month 6PCL, fear, neutral 
#fear
...
ggplot(data=AURORA_BLA1, aes(y=PCL_residuals,x=R_BLA))+ 
